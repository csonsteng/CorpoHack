...
{
	public class AbstractTrashData<TCard, TRarity, TEffect, TTargetData, TTargetConfiguration, TTarget> : ISerializable
		...
		where TTarget : System.Enum
	{
		...
		public void Add(TCard card) => _cards.AddToTop(card);   // adds to top since "face up"
		public void Remove(TCard card) => _cards.RemoveCard(card);
